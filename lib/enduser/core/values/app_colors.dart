...
abstract class AppColors {
  ...
  static const Color appColor = Color.fromRGBO(0, 0, 0, 1.0);
  //static const Color appColor = Color.fromRGBO(251, 97, 7, 1);
  static const Color black = Color.fromRGBO(0, 0, 0, 1.0);
  static const Color textprimary = Color.fromRGBO(40, 39, 35, 0.8784313725490196);
  // static const Color pageBackground = Color(0xFFFFFFFF);
  static const Color orderDateClr = Color(0x80323232);
  ...
  static const Color colorBlue = Color(0xFF4289FA);
  ...
  static Color elevatedContainerColorOpacity = Colors.grey.shade200;
  static const Color suffixImageColor = Colors.grey;
  static const lightGreenColor=Color(0xFF429442);
}
