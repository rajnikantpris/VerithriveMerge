...
class ConsultationBookingController extends BaseController {
  ...
  bool isEditMode = false; // Flag to indicate edit mode
        ...
        try {
          ...
          final result = await Get.toNamed(
            ...
            arguments: {
              ...
              'service_format_id': finalServiceFormatId, // service_format_id for summary
              'professional_service_format_id': finalProfessionalServiceFormatId, // _id for create-booking API
              'booking_id': bookingId, // Pass booking_id for edit mode
              'is_edit_mode': isEditMode, // Pass edit mode flag
            },
          );
  ...
  void _generateTimeSlotsFromAPIOld() {
    ...
    while (_isTimeBeforeOrEqual(currentTime, untilTime)) {
      ...
      // Check if this time slot is in unavailable_times (from API)
      bool isUnavailable = _isTimeSlotUnavailable(currentTime);
    ...
    try {
      ...
      while (currentMinutes < untilMinutes && iterationCount < maxIterations) {
        ...
        try {
          ...
          print('Error processing time slot at iteration $iterationCount: $e');
      ...
      print('Generated ${slots.length} time slots in $iterationCount iterations');
  ...
  bool _isTimeSlotUnavailable(TimeOfDay slotTime) {
    try {
        ...
        try {
          ...
          if (fromStr != null && toStr != null && 
            ...
            if (fromTime != null && toTime != null) {
              ...
              // Check if slot time falls within unavailable range
