...
class TherapistDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      final therapistId =
          therapistArg?.id?.toString() ?? controller.therapist.value.id;
      ...
      final therapistPrice = AnalyticsService.validatePrice(
          controller.therapist.value.price > 0
              ? controller.therapist.value.price
              : (therapistArg?.price ?? 0.0));
      ...
      AnalyticsService.instance.logViewItemEvent(
        item: AnalyticsService.instance.buildItem(
          ...
          itemName: therapistSpecialty.isNotEmpty
              ? therapistSpecialty
              : (therapistName.isNotEmpty ? therapistName : ''),
          itemCategory: category,
          itemVariant: therapistSpecialty,
          itemBrand: therapistServices.isNotEmpty
              ? therapistServices.first
              : therapistSpecialty,
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () async {
                final id =
                    controller.professionalId ?? controller.therapist.value.id;
                          ...
                          onPressed: () {
                            ...
                            final _bookingCategory =
                              ...
                              itemBrand: controller
                                      .therapist.value.services.isNotEmpty
                              ...
                              AnalyticsService.instance.logSelectItemEvent(
                                item: AnalyticsService.instance.buildItem(
                                  ...
                                  itemBrand: therapist.services.isNotEmpty
                                      ...
                                      : therapist.specialty,
                                  price: AnalyticsService.validatePrice(
                                      package.price),
                                  quantity: 1,
                                ),
                                currency: 'GBP',
                            ...
                            int? durationMinutes;
                            try {
                              String durationStr = package.duration
                            ...
                            print("Rajnikant testing testing --->" +
                                controller.isGuest.value.toString());
                            ...
                            if (!controller.isGuest.value) {
                              ...
                              Get.to(() => const LoginView(),
                                  binding: LoginBinding(), arguments: "guest");
                            }
                          },
        ...
        onPressed: () {
          ...
          if (!controller.isGuest.value) {
            ...
            final conversation = Conversation(
              ...
              name: therapist.name,
              profileImageUrl:
                  therapist.imageUrl.isNotEmpty ? therapist.imageUrl : null,
              lastMessage: '',
