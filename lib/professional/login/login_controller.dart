...
class ProfessionalLoginController extends BaseController {
  ...
  Future<void> _navigateBasedOnUserFlags(
    ...
    // Incomplete wizard (e.g. user tapped Skip earlier) → Home + setup banner.
    // Do not force signup_profile_wizard on login/logout/login.
    if (!wizardComplete) {
    ...
    // All wizard steps completed - navigate to home
