  ...
  Future<bool> requestCameraAndStoragePermissions() async {
    try {
      ...
      if (!Platform.isAndroid) {
        // iOS: mirror notification/location behavior – no Settings dialog.
        // If both permissions are already granted, return true immediately.
        ...
        if (currentCameraStatus.isGranted &&
            (currentPhotosStatus.isGranted ||
                currentPhotosStatus == PermissionStatus.limited)) {
          return true;
        }

        // Otherwise, ask via the system prompt(s) and return the result.
